<template>
  ...
  <div class="slide-in-left-to-rigth d-flex flex-wrap align-center justify-center mt-3">
    ...
    <div>
      ...
      <div class="align-left">
        <v-btn class="mr-3 mb-5" append-icon="mdi-download" v-on:click="download()" title="Scarica CV"
          aria-valuetext="Scarica CV">Scarica CV</v-btn>
      </div>
    </div>
  </div>
  ...
  <div class="slide-in-rigth-to-left d-flex flex-wrap-reverse align-center justify-center mt-3">
    <div>
      ...
      <div class="align-left">
        <v-btn class="mr-3 mb-5" append-icon="mdi-arrow-u-right-bottom" v-on:click="navigator('/progetti')"
          variant="text">Vai ai progetti</v-btn>
      </div>
    </div>
  ...
  <div class="slide-in-left-to-rigth d-flex flex-wrap align-center mt-3">
    ...
    <div>
      ...
      <div class="align-left">
        <v-btn class="mr-3 mb-5" append-icon="mdi-arrow-u-right-bottom" v-on:click="navigator('/chisono')"
          variant="text">Scopri di più</v-btn>
      </div>
    </div>
  </div>
